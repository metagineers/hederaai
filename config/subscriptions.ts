...
export const pricingData: SubscriptionPlan[] = [
  {
    ...
    benefits: [
      "Test using current test scenarios",
      "Access viability of platform",
      "Get a better understanding before subscribing",
    ],
    limitations: [
      "Only test scenarios.",
      "No customer support",
